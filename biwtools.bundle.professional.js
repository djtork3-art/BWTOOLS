...
.bwo-fab-menu-version::after {
            content: "v1.7.48 Puja recomendada directa";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.48":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.48-recommendations-direct-recommended-bid";
...
var bwoRuntimeToken=`v1.7.48-${Date.now()}-${Math.random().toString(36).slice(2)}`;
