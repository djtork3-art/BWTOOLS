...
.bwo-fab-menu-version::after {
            content: "v1.8.0 Suite profesional integral";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.8.0":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.8.0-professional-suite";
...
/* BIWTOOLS PRO SUITE v1.8.0: módulos lógicos en un único bundle. */
var bwoSuiteVersion="1.8.0",bwoSuiteMetrics={startedAt:Date.now(),requests:0,errors:0,rateLimits:0,totalMs:0,cacheHits:0,cacheMisses:0};
...
try{bwoToolsCatalog&&!bwoToolsCatalog.some(e=>e.name==="Centro de mercado")&&bwoToolsCatalog.splice(Math.max(1,bwoToolsCatalog.length-2),0,{icon:"🧭",name:"Centro de mercado",description:"Mercado, inversiones, pujas sugeridas y oportunidades en una vista profesional.",status:"Disponible"},{icon:"🔔",name:"Alertas",description:"Avisos inteligentes sobre forma, valor, participación, lesiones y oportunidades.",status:"Disponible"})}catch{}
...
var bwoRuntimeToken=`v1.8.0-${Date.now()}-${Math.random().toString(36).slice(2)}`;
