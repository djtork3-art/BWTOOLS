...
var bwoToolsCatalog=[
 {icon:"📋",name:"Actividad",category:"Liga",status:"Histórico oficial",tone:"blue",description:"Audita fichajes, ventas, abonos y movimientos económicos de toda la competición en orden cronológico.",features:["Cronología completa","Importes reales","Filtro por manager"],source:"Tablón de Biwenger"},
 ...
 {icon:"🔀",name:"Comparador",category:"Plantilla",status:"Cara a cara",tone:"cyan",description:"Enfrenta titulares, suplentes y alternativas del mercado para decidir qué cambio mejora realmente cada posición.",features:["Comparación directa","Ganancia estimada","Coste del cambio"],source:"Rendimiento y mercado"},
