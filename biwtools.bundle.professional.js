...
.bwo-fab-menu-version::after {
            content: "v1.7.30 almacenamiento autorreparable";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.30":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.30-idb-repair-progressive-render";
...
var bwoRuntimeToken=`v1.7.30-${Date.now()}-${Math.random().toString(36).slice(2)}`;
