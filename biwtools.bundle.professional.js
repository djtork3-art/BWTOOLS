...
.bwo-fab-menu-version::after {
  content: "v1.1.0 planificador jornada";
  font-size: 10px;
}
...
function bwoRoundEnsureStyles(){if(document.getElementById("bwo-round-planner-style"))return;let e=document.createElement("style");e.id="bwo-round-planner-style",e.textContent=`
  .bwo-round-planner{margin:0 0 18px;padding:18px;border:1px solid rgba(255,255,255,.11);border-top:2px solid #e0142c;border-radius:16px;color:#f5f5f5;background:linear-gradient(145deg,#202227,#121315);box-shadow:0 18px 48px rgba(0,0,0,.34);font-family:"Open Sans",system-ui,sans-serif}
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.1.0-round-planner";
