...
.bwo-fab-menu-version::after {
            content: "v1.7.25 historial íntegro y respaldo JSON";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.25":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.25-historial-integro-json";
...
var bwoRuntimeToken=`v1.7.25-${Date.now()}-${Math.random().toString(36).slice(2)}`;
