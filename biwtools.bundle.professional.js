...
.bwo-fab-menu-version::after {
            content: "v1.7.27 saldos y bonus de jornada";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.27":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.27-round-bonus-newest-wins";
...
var bwoRuntimeToken=`v1.7.27-${Date.now()}-${Math.random().toString(36).slice(2)}`;
