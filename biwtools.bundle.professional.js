...
.bwo-fab-menu-version::after {
            content: "v1.7.55 Inversiones y acciones visibles";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.55":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.55-investment-recommendations";
...
var bwoRuntimeToken=`v1.7.55-${Date.now()}-${Math.random().toString(36).slice(2)}`;
