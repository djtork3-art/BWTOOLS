...
.bwo-fab-menu-version::after {
            content: "v1.7.36 Once Jornada inteligente";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.36":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.36-matchday-xi-network-guard-rate-limit-reliable-averages-idb-repair";
...
var bwoRuntimeToken=`v1.7.36-${Date.now()}-${Math.random().toString(36).slice(2)}`;
