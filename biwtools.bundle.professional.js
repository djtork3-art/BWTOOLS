...
.bwo-fab-menu-version::after {
            content: "v1.7.50 Once unificado";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.50":t,n,r)};
...
function bwoMatchdayXICloseLeagueLineups(){let e=document.querySelector(".bwo-xi-league-view"),t=document.querySelector(".bwo-xi-tool");if(!e)return;let n=zv?.querySelector(".bwo-panel"),r=zv?.querySelector(".bwo-fab");n&&r?.click(),setTimeout(()=>{zv?.querySelector(".bwo-fab-menu")&&r?.click(),Or.classList.remove("bwo-tools-embedded"),document.body.appendChild(Or),e.remove(),t&&(t.hidden=!1,t.scrollIntoView({block:"start"}))},80)}
function bwoMatchdayXIOpenLeagueLineups(){let e=document.querySelector(".bwo-tools-page-host"),t=e?.querySelector(".bwo-xi-tool");if(!e||!t)return;t.hidden=!0;let n=bwoBidsNode("section","bwo-xi-league-view"),r=bwoBidsNode("header","bwo-xi-head"),o=bwoBidsNode("div","bwo-xi-head-main"),a=bwoBidsNode("button","bwo-xi-back","← Volver al optimizador"),i=bwoBidsNode("div"),l=bwoBidsNode("span","bwo-xi-eyebrow","BIWTOOLS · ONCES DE LA LIGA"),s=bwoBidsNode("h1","bwo-xi-title","Alineaciones y formaciones"),u=bwoBidsNode("p","bwo-xi-subtitle","Consulta los onces, sistemas y jugadores utilizados por cada participante sin crear una herramienta duplicada."),c=bwoBidsNode("main","bwo-tools-detail-slot"),f=bwoBidsNode("div","bwo-tools-detail-loading","Cargando onces de la liga…");a.type="button",a.addEventListener("click",bwoMatchdayXICloseLeagueLineups),i.append(l,s,u),o.append(a,i),r.appendChild(o),c.appendChild(f),n.append(r,c),e.appendChild(n),Or.classList.add("bwo-tools-embedded"),c.appendChild(Or),bwoLaunchEmbeddedPanel("Onces"),setTimeout(()=>document.querySelector(".bwo-xi-league-view .bwo-tools-detail-loading")?.remove(),180)}
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.50-unified-lineup-center";
...
var bwoRuntimeToken=`v1.7.50-${Date.now()}-${Math.random().toString(36).slice(2)}`;
