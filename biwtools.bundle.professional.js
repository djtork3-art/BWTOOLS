...
function bwoRoundNativeCleanup(){document.querySelectorAll(".bwo-round-planner,.bwo-round-native-badge,.bwo-round-native-summary").forEach(e=>e.remove());document.querySelectorAll(".bwo-round-native-risk,.bwo-round-native-unavailable,.bwo-round-native-player").forEach(e=>{e.classList.remove("bwo-round-native-risk","bwo-round-native-unavailable","bwo-round-native-player"),e.removeAttribute("data-bwo-round-tip")})}
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.1.3-round-jornada-perfecta";
