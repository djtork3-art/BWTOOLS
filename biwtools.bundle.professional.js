...
.bwo-fab-menu-version::after {
            content: "v1.7.29 carga progresiva rápida";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.29":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.29-progressive-render-and-cash-adjustments";
...
var bwoRuntimeToken=`v1.7.29-${Date.now()}-${Math.random().toString(36).slice(2)}`;
