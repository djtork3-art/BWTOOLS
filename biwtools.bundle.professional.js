...
.bwo-fab-menu-version::after {
  content: "v1.2.2 tabla de recomendaciones ampliada";
  font-size: 10px;
}
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.2.2-expanded-recommendations-table";
...
var bwoRuntimeToken=`v1.2.2-${Date.now()}-${Math.random().toString(36).slice(2)}`;
