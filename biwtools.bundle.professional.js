...
.bwo-fab-menu-version::after {
            content: "v1.8.2 Diagnóstico de fuentes corregido";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.8.2":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.8.2-canonical-source-tests";
...
/* BIWTOOLS PRO SUITE v1.8.2: módulos lógicos en un único bundle. */
var bwoSuiteVersion="1.8.2",bwoSuiteMetrics={startedAt:Date.now(),requests:0,errors:0,rateLimits:0,totalMs:0,cacheHits:0,cacheMisses:0};
...
var bwoRuntimeToken=`v1.8.2-${Date.now()}-${Math.random().toString(36).slice(2)}`;
