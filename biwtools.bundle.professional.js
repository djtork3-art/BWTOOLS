...
.bwo-fab-menu-version::after {
            content: "v1.7.53 Once táctico visual";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.53":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.53-visual-matchday-xi";
...
var bwoRuntimeToken=`v1.7.53-${Date.now()}-${Math.random().toString(36).slice(2)}`;
