...
.bwo-fab-menu-version::after {
            content: "v1.7.49 Mejoras de banquillo";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.49":t,n,r)};
...
function bwoMatchdayXIEnsureStyles(){let e=document.getElementById("bwo-matchday-xi-styles");if(e)return;e=document.createElement("style"),e.id="bwo-matchday-xi-styles",e.textContent=`
 ...
 .bwo-xi-head-main{display:flex;align-items:flex-start;gap:17px}.bwo-xi-back,.bwo-xi-refresh,.bwo-xi-round,.bwo-xi-detail{border:1px solid #454b58;border-radius:10px;background:#20242c;color:#fff;font:700 13px inherit;cursor:pointer;padding:10px 14px}
 .bwo-xi-back:hover,.bwo-xi-refresh:hover,.bwo-xi-detail:hover{border-color:#ff3046;background:#2b2025}.bwo-xi-refresh{border-color:#9e2432;background:#49131b;white-space:nowrap}.bwo-xi-refresh:disabled{opacity:.55;cursor:wait}
 ...
 .bwo-xi-content{padding:20px}.bwo-xi-toolbar{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:14px}.bwo-xi-toolbar-copy strong{display:block;font-size:15px}.bwo-xi-toolbar-copy span{color:#969eae;font-size:12px}
 ...
 @media(max-width:680px){.bwo-xi-tool{border-radius:0;border-left:0;border-right:0}.bwo-xi-head{padding:15px 13px;display:block}.bwo-xi-head-main{display:block}.bwo-xi-back{margin-bottom:12px}.bwo-xi-refresh{width:100%;margin-top:13px}.bwo-xi-title{font-size:23px}.bwo-xi-content{padding:12px}.bwo-xi-toolbar{align-items:stretch;flex-direction:column}.bwo-xi-select{width:100%}.bwo-xi-kpis{grid-template-columns:repeat(2,1fr)}.bwo-xi-kpi{padding:11px}.bwo-xi-kpi strong{font-size:17px}.bwo-xi-table,.bwo-xi-table tbody{display:block}.bwo-xi-table thead{display:none}.bwo-xi-table tr{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:8px;align-items:center;padding:11px 10px;border-top:1px solid #292e36}.bwo-xi-table td{padding:0;border:0}.bwo-xi-table td:nth-child(2){display:none}.bwo-xi-table td:nth-child(3){grid-column:1/2;color:#aeb6c3}.bwo-xi-table td:nth-child(4){display:block;grid-column:2}.bwo-xi-table td:nth-child(5){grid-column:3;grid-row:1}.bwo-xi-table td:nth-child(6){grid-column:2/4;grid-row:2;text-align:right}.bwo-xi-player img{width:42px;height:42px;flex-basis:42px}.bwo-xi-footer{align-items:stretch;flex-direction:column}.bwo-xi-round{width:100%}}
`;document.head.appendChild(e)}
...
async function bwoOpenMatchdayXI(e=!1){bwoMatchdayXIEnsureStyles();let t=document.querySelector(".bwo-tools-page-host");if(!t)return;let n=bwoBidsNode("section","bwo-xi-tool"),r=bwoBidsNode("header","bwo-xi-head"),o=bwoBidsNode("div","bwo-xi-head-main"),a=bwoBidsNode("button","bwo-xi-back","← Herramientas"),i=bwoBidsNode("div"),l=bwoBidsNode("span","bwo-xi-eyebrow","BIWTOOLS · ASISTENTE DE JORNADA"),s=bwoBidsNode("h1","bwo-xi-title","Once Jornada"),u=bwoBidsNode("p","bwo-xi-subtitle","Cruza Biwenger con cuatro fuentes de alineaciones para recomendar titulares, suplentes, capitán y ariete con una confianza de consenso de hasta el 98 %."),c=bwoBidsNode("button","bwo-xi-refresh",e?"Actualizando…":"Actualizar análisis");a.type=c.type="button",c.disabled=e,a.addEventListener("click",bwoClauseReturnTools),c.addEventListener("click",()=>bwoOpenMatchdayXI(!0)),i.append(l,s,u),o.append(a,i),r.append(o,c);let f=bwoBidsNode("main","bwo-xi-content"),g=bwoBidsNode("div","bwo-xi-empty",e?"Actualizando plantilla y contrastando las cuatro fuentes…":"Analizando tu plantilla, alineaciones externas y todas las formaciones válidas…");f.appendChild(g),n.append(r,f),t.replaceChildren(n);try{let b=await bwoMatchdayXILoad(e);document.contains(n)&&bwoMatchdayXIRender(b,n)}catch(b){console.warn("[biwtools] No se pudo construir Once Jornada:",b),f.replaceChildren(bwoBidsNode("div","bwo-xi-empty","No se pudo preparar el once con la sesión actual. Espera unos segundos y pulsa Actualizar análisis; la herramienta respetará automáticamente el límite de peticiones de Biwenger."))}}
if(!bwoToolsCatalog.some(e=>e.name==="Once Jornada")){let e={icon:"🧠",name:"Once Jornada",category:"Jornada",status:"Consenso hasta 98 %",tone:"green",featured:!0,description:"Calcula titulares, suplentes, capitán y ariete cruzando Biwenger con cuatro fuentes de alineaciones y la previsión Media AS + SofaScore.",features:["Consenso de 4 fuentes","Mejor formación automática","Roles y banquillo optimizados"],source:"Biwenger + FútbolFantasy + Comuniate + Jornada Perfecta + Analítica Fantasy"},t=bwoToolsCatalog.findIndex(n=>n.name==="Onces");bwoToolsCatalog.splice(t<0?0:t,0,e)}
var bwoOpenToolFromPageBeforeMatchdayXI=bwoOpenToolFromPage;
bwoOpenToolFromPage=function(e){return e==="Once Jornada"?bwoOpenMatchdayXI(!1):bwoOpenToolFromPageBeforeMatchdayXI(e)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.49-recommendations-bench-future-investment";
...
var bwoRuntimeToken=`v1.7.49-${Date.now()}-${Math.random().toString(36).slice(2)}`;
