...
.bwo-fab-menu-version::after {
  content: "v1.2.0 recomendaciones inteligentes";
  font-size: 10px;
}
...
function bwoRecEnsureUpgradeStyles(){if(zv.querySelector("#bwo-rec-upgrade-styles"))return;let e=document.createElement("style");e.id="bwo-rec-upgrade-styles",e.textContent=`
 .bwo-rec-upgrade{grid-column:1/-1;border-color:rgba(95,203,114,.25)!important;background:linear-gradient(145deg,rgba(25,29,34,.98),rgba(14,16,20,.98))!important}.bwo-rec-upgrade-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.bwo-rec-upgrade-head h3{margin:0;color:#fff;font-size:15px}.bwo-rec-upgrade-head p{margin:4px 0 0;color:var(--bwo-muted);font-size:10px;line-height:1.45}.bwo-rec-refresh{padding:6px 10px;border:1px solid rgba(255,255,255,.14);border-radius:8px;color:#fff;background:#252830;cursor:pointer;font:800 9px/1.2 var(--bwo-font-body)}
 .bwo-rec-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:7px;margin:11px 0}.bwo-rec-kpi{padding:8px 9px;border:1px solid rgba(255,255,255,.075);border-radius:8px;background:rgba(0,0,0,.18)}.bwo-rec-kpi span{display:block;color:var(--bwo-muted);font-size:7px;font-weight:900;letter-spacing:.06em;text-transform:uppercase}.bwo-rec-kpi strong{display:block;margin-top:3px;color:#fff;font-size:12px}.bwo-rec-kpi.good strong{color:var(--bwo-green)}.bwo-rec-kpi.bad strong{color:var(--bwo-coral)}
 .bwo-rec-sources{display:flex;align-items:center;flex-wrap:wrap;gap:5px;margin:0 0 10px;color:var(--bwo-muted);font-size:8px}.bwo-rec-sources span{font-weight:800}.bwo-rec-sources a{padding:3px 6px;border:1px solid rgba(255,255,255,.09);border-radius:999px;color:#b9c6df;text-decoration:none}.bwo-rec-sources a:hover{border-color:rgba(224,20,44,.55);color:#fff}.bwo-rec-upgrade-wrap{overflow:auto;border:1px solid rgba(255,255,255,.08);border-radius:9px}.bwo-rec-upgrade-table{width:100%;min-width:1080px;border-collapse:collapse}.bwo-rec-upgrade-table th{padding:8px;background:#1d2025;color:var(--bwo-muted);font-size:7px;letter-spacing:.06em;text-align:left;text-transform:uppercase}.bwo-rec-upgrade-table td{padding:8px;border-top:1px solid rgba(255,255,255,.06);color:#d6d9df;font-size:9px;vertical-align:middle}.bwo-rec-upgrade-table tr:hover{background:rgba(255,255,255,.025)}
 .bwo-rec-player{display:flex;align-items:center;gap:7px;min-width:145px;cursor:pointer}.bwo-rec-player img{width:30px;height:30px;border-radius:50%;object-fit:cover;background:#202227}.bwo-rec-player strong{display:block;color:#fff}.bwo-rec-player small,.bwo-rec-cell-sub{display:block;margin-top:2px;color:var(--bwo-muted);font-size:7px}.bwo-rec-verdict,.bwo-rec-economy{display:inline-flex;padding:3px 6px;border-radius:999px;font-size:7px;font-weight:900;white-space:nowrap}.bwo-rec-verdict.clear,.bwo-rec-economy.ok{color:#9beaab;background:rgba(95,203,114,.13)}.bwo-rec-verdict.maybe{color:#f0cf82;background:rgba(216,166,70,.14)}.bwo-rec-verdict.watch,.bwo-rec-economy.no{color:#ff9b8b;background:rgba(226,102,75,.13)}.bwo-rec-gain{color:var(--bwo-green);font-weight:900}.bwo-rec-form{font-variant-numeric:tabular-nums;white-space:nowrap}.bwo-rec-form b{display:inline-block;min-width:17px;margin-right:2px;padding:2px 3px;border-radius:4px;background:#242831;color:#fff;text-align:center}.bwo-rec-upgrade-action{padding:6px 8px;border:1px solid rgba(95,203,114,.45);border-radius:7px;color:#9beaab;background:rgba(95,203,114,.12);cursor:pointer;font:900 8px/1.2 var(--bwo-font-body);white-space:nowrap}.bwo-rec-upgrade-foot{margin:9px 1px 0;color:var(--bwo-muted);font-size:8px;line-height:1.45}
 @media(max-width:720px){.bwo-rec-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.bwo-rec-upgrade-head{flex-direction:column}}
`;zv.appendChild(e)}
...
bwoEnhanceRecommendations=async function(e=!1){await bwoEnhanceRecommendationsUpgradeBase(e),await bwoRecommendationRenderUpgrade(e)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.2.0-smart-market-recommendations";
