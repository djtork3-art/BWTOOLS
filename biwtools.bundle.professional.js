...
.bwo-fab-menu-version::after {
            content: "v1.7.26 endpoints originales y saldos";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.26":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.26-endpoints-originales";
...
async function bwoBalancePrepareRebuild(){let e=await z(),t=e.state.syncState;if(t.bwoBalanceEngineV1726==="1")return;t.bwoBalanceEngineV1726="rebuilding",t.bwoBalanceEngineV1725="rebuilding",t.bwoBalanceEngineV1724="rebuilding",t.bwoBalanceEngineV1723="rebuilding",t.bwoBalanceEngineV1721="rebuilding",e.state.movements=[],e.state.shadowStartingBalances={},e.state.bwoBalanceShadows={},e.state.startingBalances={},e.state.startingBalancesUnresolved={},e.movementIds.clear(),e.movementFingerprints.clear();for(let n of new Set([...bwoBalanceEventTypes,"market","transfer","roundFinished","exchange","loan"]))t[`lastSeenDate:${n}`]="";t.movementsHistoryCompleteV1="",t.seasonAnchorDate="",t.seasonStartingBalance="",t.seasonDistribution="",t.shadowStartingBalancesAnchor="",t.bwoBalanceShadowAnchor="",t.bwoBalanceShadowSignature="",t.bwoBalanceShadowEngine="",delete e.state.balanceCorrections,delete t.seasonStartingBalanceLockedV3,await Cu()}
...
var bwoRuntimeToken=`v1.7.26-${Date.now()}-${Math.random().toString(36).slice(2)}`;
