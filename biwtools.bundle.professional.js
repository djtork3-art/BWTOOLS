...
.bwo-fab-menu-version::after {
  content: "v1.1.1 jornada al final";
  font-size: 10px;
}
...
var bwoOriginalRoundPlannerPlacement=bwoEnhanceRoundPlanner;
bwoEnhanceRoundPlanner=async function(e=!1){await bwoOriginalRoundPlannerPlacement(e);let t=document.querySelector("main.container")??document.querySelector("main"),n=t?.querySelector(":scope > .bwo-round-planner");n&&n.parentElement===t&&t.lastElementChild!==n&&t.appendChild(n)};

globalThis.__BIWTOOLS_BALANCE_FIX__="v1.1.1-round-planner-bottom";
