...
.bwo-fab-menu-version::after {
            content: "v1.7.52 Carga directa de onces";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.7.52":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.7.52-direct-league-lineups";
...
var bwoRuntimeToken=`v1.7.52-${Date.now()}-${Math.random().toString(36).slice(2)}`;
