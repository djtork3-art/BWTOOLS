...
.bwo-fab-menu-version::after {
  content: "v1.6.2 móvil optimizado";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.6.2":t,n,r)};
...
function bwoClauseEnsureStyles(){let e=document.getElementById("bwo-clause-tool-styles");if(e?.dataset.bwoVersion==="1.6.2")return;e||(e=document.createElement("style"),e.id="bwo-clause-tool-styles"),e.dataset.bwoVersion="1.6.2",e.textContent=`
 ...
 .bwo-clause-summary{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 2px 10px;color:#8f98a6;font-size:9px}.bwo-clause-summary strong{color:#fff}.bwo-clause-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:11px}.bwo-clause-card{position:relative;overflow:hidden;padding:14px;border:1px solid rgba(255,255,255,.09);border-radius:13px;background:linear-gradient(150deg,#20242c,#15171c);box-shadow:0 8px 20px rgba(0,0,0,.16)}.bwo-clause-card.affordable{border-color:rgba(105,221,131,.28)}.bwo-clause-card::before{position:absolute;top:0;left:0;width:100%;height:2px;background:#586171;content:""}.bwo-clause-card.affordable::before{background:#69dd83}.bwo-clause-card.near::before{background:#efbd58}
 .bwo-clause-rank{position:absolute;top:11px;right:11px;display:grid;width:27px;height:27px;place-items:center;border-radius:8px;color:#fff;background:#2a2f39;font-size:9px;font-weight:950}.bwo-clause-player{display:flex;align-items:center;gap:10px;padding-right:34px}.bwo-clause-player img{width:48px;height:48px;border-radius:50%;object-fit:cover;background:#2a2e36}.bwo-clause-player h3{margin:0;color:#fff;font-size:13px;line-height:1.2}.bwo-clause-player p{margin:4px 0 0;color:#8f98a6;font-size:8px}.bwo-clause-owner{display:inline-flex;margin-top:5px;padding:3px 6px;border-radius:999px;color:#c6cdd7;background:rgba(255,255,255,.07);font-size:7px;font-weight:800}
 .bwo-clause-verdict{display:flex;align-items:center;justify-content:space-between;gap:8px;margin:12px 0 9px;padding:8px 9px;border-radius:8px;background:rgba(0,0,0,.18)}.bwo-clause-verdict strong{color:#fff;font-size:9px}.bwo-clause-badge{padding:4px 7px;border-radius:999px;font-size:7px;font-weight:950;white-space:nowrap}.bwo-clause-badge.top,.bwo-clause-badge.good{color:#aef2bc;background:rgba(105,221,131,.13)}.bwo-clause-badge.watch{color:#f5d995;background:rgba(239,189,88,.14)}.bwo-clause-badge.out{color:#ffaea3;background:rgba(255,113,95,.13)}
 .bwo-clause-metrics{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.bwo-clause-metric{padding:8px 9px;border-radius:8px;background:rgba(255,255,255,.045)}.bwo-clause-metric span{display:block;color:#818b9a;font-size:7px;font-weight:850;text-transform:uppercase}.bwo-clause-metric strong{display:block;margin-top:3px;color:#fff;font-size:10px;font-variant-numeric:tabular-nums}.bwo-clause-metric.good strong{color:#69dd83}.bwo-clause-metric.bad strong{color:#ff806e}
 .bwo-clause-progress{height:5px;margin:10px 0 7px;overflow:hidden;border-radius:999px;background:#292e37}.bwo-clause-progress span{display:block;height:100%;border-radius:inherit;background:#69dd83}.bwo-clause-card.near .bwo-clause-progress span{background:#efbd58}.bwo-clause-card:not(.affordable):not(.near) .bwo-clause-progress span{background:#ff715f}.bwo-clause-reason{min-height:30px;margin:0;color:#9da6b3;font-size:8px;line-height:1.45}
 .bwo-clause-actions{display:flex;gap:7px;margin-top:11px}.bwo-clause-action{flex:1;padding:8px}.bwo-clause-action.primary{border-color:rgba(105,221,131,.35);color:#b6f3c2;background:rgba(105,221,131,.1)}.bwo-clause-action:disabled{opacity:.45;cursor:not-allowed}.bwo-clause-empty,.bwo-clause-loading{padding:36px 18px;border:1px dashed rgba(255,255,255,.13);border-radius:12px;color:#9ca5b2;background:#171a20;text-align:center;font-size:10px;line-height:1.6}
 @media(max-width:950px){.bwo-clause-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.bwo-clause-filters{grid-template-columns:1fr 1fr}.bwo-clause-filters .bwo-clause-search{grid-column:1/-1}}
 @media(max-width:600px){.bwo-clause-head{align-items:stretch;flex-direction:column;padding:14px}.bwo-clause-head-main{gap:9px}.bwo-clause-title{font-size:19px}.bwo-clause-subtitle{font-size:9px}.bwo-clause-body{padding:12px}.bwo-clause-kpis{gap:7px}.bwo-clause-kpi{padding:10px}.bwo-clause-kpi strong{font-size:13px}.bwo-clause-filters{grid-template-columns:1fr}.bwo-clause-filters .bwo-clause-search{grid-column:auto}.bwo-clause-grid{grid-template-columns:1fr}.bwo-clause-summary{align-items:flex-start;flex-direction:column}.bwo-clause-card{padding:12px}}
...
function bwoClauseNativePlayerUrl(e){let t=e?.catalog?.url??e?.url;if(typeof t==="string"&&t.includes("/players/"))return t.startsWith("http")?new URL(t).pathname:t;let n=e?.catalog?.competition?.slug??e?.catalog?.competition_slug??e?.catalog?.competitionSlug??"la-liga",r=e?.catalog?.slug??bwoClauseSlug(e?.name);return n==="primera-division"&&(n="la-liga"),`/${n}/players/${r}`}
function bwoClauseOpenDetail(e){let t=bwoClauseNativePlayerUrl(e),n=e?.catalog?.slug??bwoClauseSlug(e.name),r=[...document.querySelectorAll("a[href*='/players/']")].find(o=>{let a=o.getAttribute("href")??"";return a===t||a.endsWith(`/players/${n}`)||o.closest("player-card")?.querySelector(`img[src*="/i/p/${e.id}.png"]`)});bwoCloseToolsPage(),setTimeout(()=>{if(r){r.click();return}location.assign(t)},80)}
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.6.2-clausulas-native-player";
...
var bwoRuntimeToken=`v1.6.2-${Date.now()}-${Math.random().toString(36).slice(2)}`;
