...
.bwo-fab-menu-version::after {
  content: "v1.2.1 instancia única + recomendaciones inteligentes";
  font-size: 10px;
}
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.2.1-singleton-smart-market-recommendations";
...
var bwoRuntimeToken=`v1.2.1-${Date.now()}-${Math.random().toString(36).slice(2)}`;
