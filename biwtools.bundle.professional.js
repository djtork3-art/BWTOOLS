...
.bwo-fab-menu-version::after {
  content: "v1.3.0 diagnóstico profesional";
  font-size: 10px;
}
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.3.0-professional-diagnostics";
...
var bwoRuntimeToken=`v1.3.0-${Date.now()}-${Math.random().toString(36).slice(2)}`;
