...
.bwo-fab-menu-version::after {
  content: "v1.6.3 resultados compactos";
  font-size: 10px;
}
...
bwoDiagKpi=function(e,t,n,r=""){return bwoDiagKpiVersionBase(e,e==="Versión"?"v1.6.3":t,n,r)};
...
globalThis.__BIWTOOLS_BALANCE_FIX__="v1.6.3-clausulas-compactas-slug-oficial";
...
var bwoRuntimeToken=`v1.6.3-${Date.now()}-${Math.random().toString(36).slice(2)}`;
